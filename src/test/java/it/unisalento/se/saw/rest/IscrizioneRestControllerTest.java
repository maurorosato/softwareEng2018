...
private MockMvc mockMvc;
	...
	@Captor
    private ArgumentCaptor<Iscrizione> savedIscrizione;
	...
	public void getAllIscrizioneStudenteTest() throws Exception {
		...
		mockMvc.perform(get("/iscrizione/getIscrizione/{idInsegnamento}/{idUserStudente}", insegnamento.getIdinsegnamento(), studente.getUtente().getIdutente()))
	...
	@Test
	public void saveIscrizioneTest() throws Exception {
		...
		mockMvc.perform(post("/iscrizione/save")
				.contentType(MediaType.APPLICATION_JSON_UTF8)
				.content(toJson(iscrizione)))
				.andExpect(status().isOk());

	    verify(iscrizioneServiceMock, times(1)).save(savedIscrizione.capture());
	    verifyNoMoreInteractions(iscrizioneServiceMock);
